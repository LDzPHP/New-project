...
@section('content')
    {{--@include('partials.form')--}}
     <div class="bg-gradient-to-r from-yellow-400 to-white max-w-fit rounded-md mx-10">
        ...
        @csrf
                <label>
                        <h1 class="w-60 mx-20 bg-orange-500 p-2 m-1 rounded-md text-white opacity-80">EDIT PRINT</h1>
                </label>

                <div class="form mx-10 my-5">

                        <label class="input w-60 mx-10 bg-orange-500 p-2 m-1 rounded-md opacity-80" input type="submit">
